...
短板/高成本环节：
- 46/200 样本仍错误（23%），其中 15 例为 Critic gate 相关、12 例为数据覆盖空洞。
...
| 中 | degraded/no_vector 最小召回增强 | 缓解 3 例 MINER_COVERAGE，提升弱配置稳定性。 | 比较 ablation 中 degraded/no_vector 的 graded_total>=2 比率。 |
