...
def test_extract_node_metrics_from_trace_json():
    ...
    trace = {
        "events": [
            {"node": "miner", "latency_ms": 10, "input_tokens": 100, "output_tokens": 20, "cost_usd": 0.01},
            {"node": "critic", "latency_ms": 15, "input_tokens": 120, "output_tokens": 10, "cost_usd": 0.02},
            {"node": "miner", "latency_ms": 8, "input_tokens": 80, "output_tokens": 15, "cost_usd": 0.008},
        ]
    }
